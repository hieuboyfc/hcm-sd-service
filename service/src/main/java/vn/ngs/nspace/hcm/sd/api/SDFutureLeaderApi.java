...
@Tag(name = "SDFutureLeaderApi", description = "SD Future Leader Api")
public class SDFutureLeaderApi {

    private final SDFutureLeaderService service;

    @GetMapping("/list")
    @Operation(summary = "Get List - SD Future Leader", description = "Get List - SD Future Leader", tags = {"SDFutureLeader"})
    ...
    @PostMapping("/create")
    @Operation(summary = "Create - SD Future Leader", description = "Create - SD Future Leader", tags = {"SDFutureLeader"})
    @ActionMapping(action = Permission.CREATE)
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
    public ResponseEntity<?> create(@Parameter(description = "Id of Company") @RequestHeader Long cid,
                                    @Parameter(description = "Id of User") @RequestHeader String uid,
                                    @Parameter(description = "Payload Create") @RequestBody SDFutureLeaderDTO dto) {
        try {
    ...
    @PutMapping("/update")
    @Operation(summary = "Update - SD Future Leader", description = "Update - SD Future Leader", tags = {"SDFutureLeader"})
    @ActionMapping(action = Permission.UPDATE)
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
    public ResponseEntity<?> update(@Parameter(description = "Id of Company") @RequestHeader Long cid,
                                    @Parameter(description = "Id of User") @RequestHeader String uid,
                                    @Parameter(description = "Payload Update") @RequestBody SDFutureLeaderDTO dto) {
        try {
    ...
    @Operation(summary = "Delete - SD Future Leader", description = "Delete - SD Future Leader", tags = {"SDFutureLeader"})
    ...
    @ActionMapping(action = Permission.VIEW)
    @Operation(summary = "Get Detail - SD Future Leader", description = "Get Detail - SD Future Leader", tags = {"SDFutureLeader"})
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
