...
@RestController
@RequestMapping(value = "/sd-reason-leave")
@Tag(name = "SDReasonLeaveApi", description = "SD Reason Leave Api")
public class SDReasonLeaveApi {

    private final SDReasonLeaveService service;

    @GetMapping("/list")
    @Operation(summary = "Get List - SD Reason Leave", description = "Get List - SD Reason Leave", tags = {"SDReasonLeave"})
    ...
    @PostMapping("/create")
    @Operation(summary = "Create - SD Reason Leave", description = "Create - SD Reason Leave", tags = {"SDReasonLeave"})
    @ActionMapping(action = Permission.CREATE)
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
    public ResponseEntity<?> create(@Parameter(description = "Id of Company") @RequestHeader Long cid,
                                    @Parameter(description = "Id of User") @RequestHeader String uid,
                                    @Parameter(description = "Payload Create") @RequestBody SDReasonLeaveDTO dto) {
        try {
    ...
    @PutMapping("/update")
    @Operation(summary = "Update - SD Reason Leave", description = "Update - SD Reason Leave", tags = {"SDReasonLeave"})
    @ActionMapping(action = Permission.UPDATE)
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
    public ResponseEntity<?> update(@Parameter(description = "Id of Company") @RequestHeader Long cid,
                                    @Parameter(description = "Id of User") @RequestHeader String uid,
                                    @Parameter(description = "Payload Update") @RequestBody SDReasonLeaveDTO dto) {
        try {
    ...
    @Operation(summary = "Delete - SD Reason Leave", description = "Delete - SD Reason Leave", tags = {"SDReasonLeave"})
    ...
    @ActionMapping(action = Permission.VIEW)
    @Operation(summary = "Get Detail - SD Reason Leave", description = "Get Detail - SD Reason Leave", tags = {"SDReasonLeave"})
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
