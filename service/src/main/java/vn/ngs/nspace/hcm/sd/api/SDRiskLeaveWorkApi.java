...
@RestController
@RequestMapping(value = "/sd-risk-leave-work")
@Tag(name = "SDRiskLeaveWorkApi", description = "SD Risk Leave Work Api")
public class SDRiskLeaveWorkApi {

    private final SDRiskLeaveWorkService service;

    @GetMapping("/list")
    @Operation(summary = "Get List - SD Risk Leave Work", description = "Get List - SD Risk Leave Work", tags = {"SDRiskLeaveWork"})
    ...
    @PostMapping("/create")
    @Operation(summary = "Create - SD Risk Leave Work", description = "Create - SD Risk Leave Work", tags = {"SDRiskLeaveWork"})
    @ActionMapping(action = Permission.CREATE)
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
    public ResponseEntity<?> create(@Parameter(description = "Id of Company") @RequestHeader Long cid,
                                    @Parameter(description = "Id of User") @RequestHeader String uid,
                                    @Parameter(description = "Payload Create") @RequestBody SDRiskLeaveWorkDTO dto) {
        try {
    ...
    @PutMapping("/update")
    @Operation(summary = "Update - SD Risk Leave Work", description = "Update - SD Risk Leave Work", tags = {"SDRiskLeaveWork"})
    @ActionMapping(action = Permission.UPDATE)
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
    public ResponseEntity<?> update(@Parameter(description = "Id of Company") @RequestHeader Long cid,
                                    @Parameter(description = "Id of User") @RequestHeader String uid,
                                    @Parameter(description = "Payload Update") @RequestBody SDRiskLeaveWorkDTO dto) {
        try {
    ...
    @Operation(summary = "Delete - SD Risk Leave Work", description = "Delete - SD Risk Leave Work", tags = {"SDRiskLeaveWork"})
    ...
    @ActionMapping(action = Permission.VIEW)
    @Operation(summary = "Get Detail - SD Risk Leave Work", description = "Get Detail - SD Risk Leave Work", tags = {"SDRiskLeaveWork"})
    @Parameter(in = ParameterIn.HEADER, description = "Addition Key to bypass authen", name = "key",
            schema = @Schema(implementation = String.class))
